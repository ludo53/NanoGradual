...
#[derive(Debug)]
pub struct NanoGradualProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NanoGradualProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NanoGradual processing");
    
    let mut processor = NanoGradualProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NanoGradualProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NanoGradualProcessor::new(false);
